    ...
    def __init__(self, inp, oup, stride, expand_ratio):
        ...
        if expand_ratio == 1:
            self.conv = nn.Sequential(
                ...
                nn.ReLU6(inplace=True),
                #-----------------------------------#
                #   1x1 pointwise convolution to adjust channel count
                #-----------------------------------#
            ...
            self.conv = nn.Sequential(
                ...
                nn.ReLU6(inplace=True),
                #-----------------------------------#
                #   1x1 pointwise convolution to reduce channels
                #-----------------------------------#
                nn.Conv2d(hidden_dim, oup, 1, 1, 0, bias=False),
                BatchNorm2d(oup),
            )
...
def mobilenetv2(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # The custom MobileNetV2 architecture matches torchvision's; strict=False
        # handles minor key differences in the classifier head.
        import torchvision.models as models
        pretrained_dict = models.mobilenet_v2(pretrained=True).state_dict()
